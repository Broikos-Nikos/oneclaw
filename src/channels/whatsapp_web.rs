...
//! session_path = "~/.OneClaw/whatsapp-session.db"  # Required for Web mode
...
// â”€â”€ Media attachment support â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
fn parse_wa_attachment_markers(message: &str) -> (String, Vec<WaAttachment>) {
    ...
    while cursor < message.len() {
        ...
        if let Some(attachment) = parsed {
            ...
            // Not a valid media marker â€” keep the original text.
...
/// ```toml
/// [channels_config.whatsapp]
/// session_path = "~/.OneClaw/whatsapp-session.db"
